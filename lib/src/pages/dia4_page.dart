...
class DiaCuatroPage extends StatefulWidget {
  const DiaCuatroPage({super.key});

  @override
  State<DiaCuatroPage> createState() => _DiaCuatroPageState();
}

class _DiaCuatroPageState extends State<DiaCuatroPage> {
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Column(children: [_imagenDiaCuatro(), _listarGruposDiaCuatro()]),
    );
  }
  ...
  Widget _listarGruposDiaCuatro() {
    return FutureBuilder(
      future: gruposProvider.mostrarGruposDiaCuatro(),
      builder: (context, AsyncSnapshot snapshot) {
        ...
        final _todosGruposDiaCuatro = grupo.items;
        print(_todosGruposDiaCuatro);
        return Column(
          children: [
            SizedBox(
              height: 400,
