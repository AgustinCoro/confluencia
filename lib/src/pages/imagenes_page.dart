...
class _ImagenesPageState extends State<ImagenesPage> {
          ...
          children: [
            Positioned(
              ...
              child: Container(
                  ...
                  width: 294,
                  child: Image(image: AssetImage("aa/top.png", ))
                ) ,
            ),
            Positioned(
              top: 300,
            ...
            Positioned(
              ...
              child: Container(
                  height: 280, // Altura deseada
                  width: 294,
                  child: Image(image: AssetImage("aa/logoFecha.png", ))
                ) ,
            ),
            ...
            Positioned(
              ...
              child: Container(
                  height: 280, // Altura deseada
                  width: 294,
                  child: Image(image: AssetImage("aa/Foot.png", ))
                ) ,
            ),
  ...
  Widget _imagenFooter(){
    return Image(image: AssetImage('aa/Foot.png'),
      width: 300.0,
      );
  }
  ...
  Widget _botonDiaDos(currentIndex)
  {
    return GestureDetector(
      ...
      child: Padding(
        ...
        child: Image(image: AssetImage('aa/Btn_Dia2.png'),
        width: 150.0,
        ),
      ),
    );
  ...
  Widget _botonGrilla(currentIndex)
  {
    return GestureDetector(
      ...
      child: Padding(
        ...
        child: Image(image: AssetImage('aa/Btn_MiGrilla.png'),
        width: 150.0,
        ),
      ),
    );
  ...
  Widget _botonMapa(currentIndex)
  {
    return GestureDetector(
      ...
      child: Padding(
        padding: const EdgeInsets.only(),
        child: Image(image: AssetImage('aa/Btn_MiMapa.png'),
        width: 150.0,
        ),
      ),
    );
